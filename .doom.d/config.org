...
#+END_SRC
Allows for setting the system theme to the theme used in emacs
#+BEGIN_SRC emacs-lisp
(package! theme-magic)
#+END_SRC
Requires pywal
...
(package! beacon)
#+END_SRC
Automatically resizing the windows for the size specified in the golden ratio
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (counsel-tramp sos org-super-agenda org-chef org-bullets beacon avy)))
