...
(setq
 ...
 doom-variable-pitch-font (font-spec :family "IBM Plex Mono" :size 22 :weight 'regular)
...
*** Capture
#+BEGIN_SRC emacs-lisp
(after! org (require 'org-roam-protocol))
#+END_SRC
#+BEGIN_SRC emacs-lisp
...
This provides a mode for an authinfo file \rightarrow syntax highlighting
#+BEGIN_SRC emacs-lisp
